...
public class PredictorDaoTest extends AbstractDaoTest {
    ...
    public void creates_predictor_when_enabled_for_the_first_time() {
        PredictorState state = predictorRepository.enablePrediction("the-type", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);

        // identifying fields:
        assertThat(state.predictorId).as("predictorId").isNotNull();
        assertThat(state.predictorType).as("predictorType").isEqualTo("the-type");
        assertThat(state.facilityId).as("facilityId").isEqualTo(facilityId);
        assertThat(state.capacityType).as("capacityType").isEqualTo(CapacityType.CAR);
        assertThat(state.usage).as("usage").isEqualTo(Usage.PARK_AND_RIDE);
        // default values:
        ...
        PredictorState javaDefaults = new PredictorState(null, null, null, null);
    ...
    public void returns_existing_predictor_when_enabled_for_the_second_time() {
        PredictorState state1 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
        PredictorState state2 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
    ...
    public void predictors_are_predictor_type_specific() {
        PredictorState state1 = predictorRepository.enablePrediction("type1", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
        PredictorState state2 = predictorRepository.enablePrediction("type2", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
    ...
    public void predictors_are_facility_specific() {
        ...
        PredictorState state1 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
        PredictorState state2 = predictorRepository.enablePrediction("predictor-type", facilityId2, CapacityType.CAR, Usage.PARK_AND_RIDE);
    ...
    public void predictors_are_capacity_type_specific() {
        PredictorState state1 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
        PredictorState state2 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.ELECTRIC_CAR, Usage.PARK_AND_RIDE);
    ...
    public void predictors_are_usage_specific() {
        PredictorState state1 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.CAR, Usage.PARK_AND_RIDE);
        PredictorState state2 = predictorRepository.enablePrediction("predictor-type", facilityId, CapacityType.CAR, Usage.COMMERCIAL);
