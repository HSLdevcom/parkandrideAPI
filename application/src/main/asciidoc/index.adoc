...
Collection URL's typically accept GET-parameters for filtering, paging and sorting items.
Reading data uses GET-method and doesn't require authorization - except for user management.
Restricted modifications use either POST on collection-URL for creating new items and
