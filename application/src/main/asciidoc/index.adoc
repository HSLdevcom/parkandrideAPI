...
in order to receive announcements of coming changes. For now, you can contact jari.honkonen@hsl.fi or kerkko.vanhanen@hsl.fi._
...
link:https://github.com/HSLdevcom/parkandrideAPI/tree/master/application/src/main/frontend/src[it's source code]
